...
class GoodInfoListTest(unittest.TestCase):
    ...
    def form_cheapset_list_goods(self):
        ...
        """
        most_cheapset_test = GoodInfoList()
        ...
        for good in list_with_object_cheapset_test:
            most_cheapset_test.add(good)

        return most_cheapset_test
    ...
    def form_ending_list_goods(self):
        ...
        """
        list_with_object_ending_test = GoodInfoList()
        ...
        for good in list_with_objects_ending_test:
            list_with_object_ending_test.add(good)

        return list_with_object_ending_test
    ...
    def form_sort_amount_list(self):
        ...
        amount sort goods
        """
        list_sort_amount = GoodInfoList()

        list_sort_amount_test = [
            GoodInfo('хлеб серый хлебозавод', '30', '0','2020-12-30', '4', '2020-12-30'),
            GoodInfo('пирожки с картошкой', '30', '2','2020-12-30', '7', '2020-12-30'),
            GoodInfo('вермишель Макфа 1кг', '45', '2','2020-12-30', '720', '2020-12-30'),
        ...
        for good in list_sort_amount_test:
            list_sort_amount.add(good)

        return list_sort_amount
    ...
    def setUp(self):
        ...
        if len(self.file_data) > 0:
            ...
            self.most_expensive_test = self.form_expensive_list_goods()
            self.most_cheapset_test = self.form_cheapset_list_goods()
            self.ending_goods_test = self.form_ending_list_goods()
            self.amount_sort_test = self.form_sort_amount_list()
            self.price_sort_test = self.form_sort_price_list()
            self.name_sort_test = self.form_sort_name_list()
    ...
    def test_get_from_file_with_empty_string(self):
        """
        Function get from file with empty string
        """
        test_get_from_file = self.info_list.get_from_file(self.file_data)
        self.assertTrue(test_get_from_file)
    ...
    def test_get_from_file_with_not_valid_string(self):
        """
        Function test get from file with not valid string
        """
        test_get_from_file = self.info_list.get_from_file(self.file_data)
        self.assertTrue(test_get_from_file)        
    ...
    def test_sort_amount(self):
        ...
        self.assertEqual(sort_amount, self.amount_sort_test)
    ...
    def test_get_list_most_expensive(self):
        ...
        self.assertEqual(expensive_goods_test, self.most_expensive_test)
